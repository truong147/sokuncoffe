          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-coffee-orange focus:border-transparent transition duration-200"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="h-4 w-4 text-coffee-orange focus:ring-coffee-orange border-gray-300 rounded"
                />
                <label
                  htmlFor="remember"
